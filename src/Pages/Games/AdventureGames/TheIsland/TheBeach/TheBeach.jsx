      ...
      <div>
        <div style={{ background: "white", opacity: "80%" }}>
          ...
          <div style={{ margin: "5px", padding: "5px" }}>
            ...
            <p>
              You lick your lips as you lever yourself upright, trying to get your bearings.
            </p>
            <p>
              You need water, and as you shade your eyes from the sun, you realize you need shade as well. Looking farther up the beach away
              from the sea, you can see a dense line of jungle and what looks
              like it might be a path leading deeper in.
            </p>

            <p>
              Looking back out to sea, you wonder if anyone is coming to rescue
              you. Should you wait here and try to light a signal fire or head
              into the jungle and try to find water? You can't forget either,
              you came here on a mission, find the treasure!
            </p>
          </div>
        </div>
        <div
        ...
        >
          ...
          {toggleWater === false ? (
            <button id="water">
              <GiWaterFlask onClick={handleToggleWater} size="4rem" />
            </button>
          ) : (
            <FindWater />
          )}
          ...
          {toggleFire === false ? (
            <button id="campfire">
              <GiCampfire onClick={handleToggleFire} size="4rem" />
            </button>
          ) : (
            <LightFire />
          )}
